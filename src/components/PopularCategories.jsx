...
export default function PopularCategories() {
  return (
    <section className="py-16 bg-gray-100 animate__animated animate__fadeInUp">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-6">
        ...
        {/* Card 1 */}
        <Card className="p-6 text-center hover:scale-105 transition animate__animated animate__zoomIn animate__delay-1s">
        ...
        {/* Card 2 */}
        <Card className="p-6 text-center hover:scale-105 transition animate__animated animate__zoomIn animate__delay-2s">
        ...
        {/* Card 3 */}
        <Card className="p-6 text-center hover:scale-105 transition animate__animated animate__zoomIn animate__delay-3s">
